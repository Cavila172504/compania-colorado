...
export class PdfReportService {
    ...
    async generateRolIndividual(flujo: FlujoCaja) {
        const doc = new jsPDF();
        ...
        autoTable(doc, {
            ...
            body: [
                ...
                ['(-) Comisión Compañía', flujo.comision_compania.toFixed(2)],
                [{ content: 'TOTAL A RECIBIR (CHEQUE)', styles: { fontStyle: 'bold', fillColor: [240, 240, 240] } },
